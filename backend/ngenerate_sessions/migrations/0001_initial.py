    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('style', models.CharField(choices=[('chinese', 'Chinese'), ('japanese', 'Japanese'), ('futuristic', 'Futuristic'), ('medieval', 'Medieval'), ('modern', 'Modern'), ('ghibli', 'Ghibli')], default='ghibli', max_length=50)),
